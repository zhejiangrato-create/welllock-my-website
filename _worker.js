...
<body>
    ...
    <section class="section" id="products">
        <div class="container">
            ...
            <h2>T Handle Locks, <strong>two finishes</strong></h2>
            <p class="lead">One zinc alloy body, two surface treatments. Chrome-plated for OEM doors, powder-coated black for heavy-duty industrial use.</p>

            <div class="thandle-grid">
                <div class="thandle-card">
                    <img class="th-img" src="https://www.nbrato.com/data/watermark/20180831/5b89015dc4298.jpg" alt="Chrome Plated Zinc Alloy T Handle Lock" />
                    <div class="th-body">
                ...
                <div class="thandle-card">
                    <img class="th-img" src="https://www.nbrato.com/data/watermark/20180911/5b97824207a9e.JPG" alt="Black Powder-Coated Zinc Alloy T Handle Lock" />
                    <div class="th-body">
            ...
            <h2 style="margin-top:64px;">More <strong>products</strong></h2>
    ...
    <script type="application/ld+json">
        {
            ...
            "image": "https://www.nbrato.com/data/watermark/20180831/5b89015dc4298.jpg",
            "additionalProperty": [
    ...
    <script type="application/ld+json">
        {
            ...
            "image": "https://www.nbrato.com/data/watermark/20180911/5b97824207a9e.JPG",
            "additionalProperty": [
